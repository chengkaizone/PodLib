...
//    }
    ...
    public init(refreshingBlock: @escaping MJRefreshComponentRefreshingBlock) {
    ...
    public init(target: Any?, refreshingAction: Selector) {
        super.init(frame: CGRect.zero)
...
//    }
    ...
    public override func endRefreshing() -> Void {
        DispatchQueue.main.async {
            self.state = .idle
